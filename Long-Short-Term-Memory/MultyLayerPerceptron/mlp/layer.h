...
class Layer {
	...
	//--- methods
		...
		void LastLayerLossGradient(std::vector<double> correctValues, std::vector<double> predictedValues);
		void HiddenLayerLossGradient(std::vector<double> LossPartialWithRespectToActivation);
		void UpdateAllNeurons();
		std::vector<double> LossPartialWithRespectToInput();
