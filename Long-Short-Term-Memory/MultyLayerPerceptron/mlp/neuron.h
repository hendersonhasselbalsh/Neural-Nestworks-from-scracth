...
class Neuron {
	...
	//--- atributos fundamentais do meuronios
		...
		std::vector<double> _lossGradient;
	...
	//--- pricipais methods
		...
		void CalculateLossGradient(double correctValue, double predictedValue, std::vector<double> input);
		void CalculateLossGradient(double LossPartialWithRespectToActivation, std::vector<double> input);
